...
export default function AddBank({ view, setView, editEmployee }) {
  const dispatch = useDispatch();

  const initialValues = {
    accountNo: editEmployee ? editEmployee.accountNo : "",
    bankName: editEmployee ? editEmployee.bankName : "",
    holderName: editEmployee ? editEmployee.holderName : "",
    ifscCode: editEmployee ? editEmployee.ifscCode : "",
  ...
  const HandleData = async (values) => {
    try {
      ...
      await dispatch(
        editEmployee?._id
          ? HandleEditBank(editEmployee._id, values)
          : HandleCreateBank(values)
      )
        .then(async (result) => {
